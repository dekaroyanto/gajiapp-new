...
<head>
    ...
    <link rel="stylesheet" crossorigin href="{{ asset('profile.css') }}">
</head>
                    ...
                    <nav class="popup-window">
                        ...
                        <ul>
                            <li><a class="dropdown-item" href="{{ route('user.profile') }}">
                                    <i class="icon-mid bi bi-person me-2 mb-2"></i>
                                    My Profile
                                </a>
                            </li>

                            <li><a class="dropdown-item" href="/password/edit">
                                    <i class="icon-mid bi bi-key-fill me-2 mb-2"></i>
                                    Ubah Password
                                </a>
                            </li>

                            <li><a class="dropdown-item" href="{{ route('user.registration') }}">
                                    <i class="bi bi-person-add mb-3"></i>
                                    Tambah Akun
                                </a>
                            </li>
                            ...
                            <li>
                                <form action="/logout" method="post">
                                    ...
                                    <button type="submit" class="dropdown-item"><i
                                            class="bi bi-box-arrow-right mb-3"></i>
                                        Logout</button>
                                </form>
                            </li>
                        </ul>
